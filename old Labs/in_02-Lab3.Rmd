...
-   The mean distance to the MRT.

-   Make a professional looking histogram of the price data with units! (see tutorial 6)


**[Step 7]:** Now use R-Commands that you learned in Labs 1, 2 and the tutorials to explore the summary statistics and distribution of the House.Price column. See if you can work out:

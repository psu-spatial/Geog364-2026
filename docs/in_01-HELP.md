...
3.  You can attend office hours (Friday afternoons, after every class or various times on zoom) - more details on Canvas:

<br>

4.  If you are really stuck you can canvas message me, but please try least one of the github/office hour options tried first.

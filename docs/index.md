...
Dr Greatrex has written this lab book to provide all the code and instructions you need for spatial analysis.  The labs have three main learning objectives.

-   To allow you to practice the concepts from the course
...
-   [The course canvas page:]{.underline} <https://psu.instructure.com/courses/2465664>
